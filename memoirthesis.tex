...
\makepagestyle{myvf} 
    ...
    \makeevenfoot{myvf}{}{\ornpar \\ \sffamily\bf \textcolor{black}{\thepage ~~~ \reflectbox{\leafNE}}  \hfill}{} 
...
\usepackage{Carrickc,ArtNouvc,Kramer,Konanur,Rothdn,Starburst,Zallman}
\usepackage{hyperref}
\usepackage{lettrine}
